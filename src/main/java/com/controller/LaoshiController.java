...
//                            laoshiEntity.setLaoshiName(data.get(0));                    //教师姓名 要改的
//                            laoshiEntity.setLaoshiPhone(data.get(0));                    //教师手机号 要改的
//                            laoshiEntity.setLaoshiIdNumber(data.get(0));                    //教师身份证号 要改的
//                            laoshiEntity.setLaoshiPhoto("");//照片
...
//                            laoshiEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String token = tokenService.generateToken(laoshi.getId(),username, "laoshi", "教师");
        R r = R.ok();
        r.put("token", token);
        r.put("role","教师");
