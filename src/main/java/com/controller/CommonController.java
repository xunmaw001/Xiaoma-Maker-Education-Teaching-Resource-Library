 ...
 */
	 ...
	 * @return
	 */
	@RequestMapping("/newSelectGroupCount1111")
	@IgnoreAuth
	public R newSelectGroupCount1111() {
		logger.debug("newSelectGroupCount:,,Controller:{}",this.getClass().getName());
		List<Map<String, Object>> result = commonService.newSelectGroupCount1111();
		return R.ok().put("data", result);
	}
