    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(yonghu !=null){
            ...
            BeanUtils.copyProperties( yonghu , view );//把实体数据重构到view中
                ...
                //级联表
                ClazzEntity clazz = clazzService.selectById(yonghu.getClazzId());
                if(clazz != null){
...
//            return R.error(511,"权限为空");
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            ...
                            yonghuEntity.setClazzId(Integer.valueOf(data.get(1)));   //班级 要改的
                            yonghuEntity.setYonghuName(data.get(2));                    //学员姓名 要改的
                            yonghuEntity.setYonghuPhone(data.get(3));                    //学员手机号 要改的
                            yonghuEntity.setYonghuIdNumber(data.get(4));                    //学员身份证号 要改的
                            yonghuEntity.setYonghuPhoto(null);//照片
                            yonghuEntity.setSexTypes(Integer.valueOf(data.get(5)));   //性别 要改的
                            yonghuEntity.setYonghuEmail(data.get(6));                    //电子邮箱 要改的
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String token = tokenService.generateToken(yonghu.getId(),username, "yonghu", "学员");
        R r = R.ok();
        r.put("token", token);
        r.put("role","学员");
