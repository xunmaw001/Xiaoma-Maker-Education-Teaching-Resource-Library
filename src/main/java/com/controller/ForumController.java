    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(forum !=null){
            ...
            BeanUtils.copyProperties( forum , view );//把实体数据重构到view中
                ...
                //级联表
                LaoshiEntity laoshi = laoshiService.selectById(forum.getLaoshiId());
                if(laoshi != null){
    ...
    */
    ...
    public R save(@RequestBody ForumEntity forum, HttpServletRequest request){
        ...
        if(StringUtil.isEmpty(role))
            ...
            forum.setLaoshiId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<ForumEntity> queryWrapper = new EntityWrapper<ForumEntity>()
            ...
            .eq("laoshi_id", forum.getLaoshiId())
...
//                            forumEntity.setYonghuId(Integer.valueOf(data.get(0)));   //学员 要改的
//                            forumEntity.setLaoshiId(Integer.valueOf(data.get(0)));   //教师 要改的
