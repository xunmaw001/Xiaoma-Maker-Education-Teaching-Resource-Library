        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='yonghu'">
                    <el-form-item class="select" v-if="type!='info'"  label="学员" prop="yonghuId">
                        <el-select v-model="ruleForm.yonghuId" filterable placeholder="请选择学员" @change="yonghuChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="学员姓名" prop="yonghuName">
                        <el-input v-model="yonghuForm.yonghuName"
                                  placeholder="学员姓名" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="学员姓名" prop="yonghuName">
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="学员手机号" prop="yonghuPhone">
                        <el-input v-model="yonghuForm.yonghuPhone"
                                  placeholder="学员手机号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="学员手机号" prop="yonghuPhone">
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="学员身份证号" prop="yonghuIdNumber">
                        <el-input v-model="yonghuForm.yonghuIdNumber"
                                  placeholder="学员身份证号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="学员身份证号" prop="yonghuIdNumber">
                ...
                <el-col :span="24" v-if="sessionTable !='yonghu' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.yonghuPhoto" label="学员头像" prop="yonghuPhoto">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.yonghuPhoto" label="学员头像" prop="yonghuPhoto">
                ...
                <el-col :span="12"  v-if="sessionTable !='zuoye'">
                    <el-form-item class="select" v-if="type!='info'"  label="作业" prop="zuoyeId">
                        <el-select v-model="ruleForm.zuoyeId" filterable placeholder="请选择作业" @change="zuoyeChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='zuoye' ">
                    <el-form-item class="input" v-if="type!='info'"  label="作业唯一编号" prop="zuoyeUuidNumber">
                        <el-input v-model="zuoyeForm.zuoyeUuidNumber"
                                  placeholder="作业唯一编号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.huifuFile" label="回答文件" prop="huifuFile">
                        <file-upload
                                tip="点击上传回答文件"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.huifuFile?ruleForm.huifuFile:''"
                                @change="huifuFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.huifuFile" label="回答文件" prop="huifuFile">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.huifuFile || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   huifuFile: [
                              { required: true, message: '回答文件不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='zuoyeId'){
                          this.ruleForm.zuoyeId = obj[o];
                          this.ro.zuoyeId = true;
                          continue;
                      }
                      if(o=='yonghuId'){
                      ...
                      if(o=='huifuFile'){
                          this.ruleForm.huifuFile = obj[o];
                          this.ro.huifuFile = true;
                          continue;
                      }
                    }
                }
            ...
            info(id) {
                this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        this.zuoyeChange(data.data.zuoyeId)
                        //解决前台上传图片后台不显示的问题
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`huida/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.huidaCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            huifuFileUploadChange(fileUrls){
                this.ruleForm.huifuFile = fileUrls;
                this.addEditUploadStyleChange()
            },
