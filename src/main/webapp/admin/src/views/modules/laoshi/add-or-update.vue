               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="教师姓名" prop="laoshiName">
                       <el-input v-model="ruleForm.laoshiName"
                                 placeholder="教师姓名" clearable  :readonly="ro.laoshiName"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="教师手机号" prop="laoshiPhone">
                       <el-input v-model="ruleForm.laoshiPhone"
                                 placeholder="教师手机号" clearable  :readonly="ro.laoshiPhone"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="教师身份证号" prop="laoshiIdNumber">
                       <el-input v-model="ruleForm.laoshiIdNumber"
                                 placeholder="教师身份证号" clearable  :readonly="ro.laoshiIdNumber"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="电子邮箱" prop="laoshiEmail">
                       <el-input v-model="ruleForm.laoshiEmail"
                                 placeholder="电子邮箱" clearable  :readonly="ro.laoshiEmail"></el-input>
                   </el-form-item>
                   <div v-else>
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='laoshiName'){
                          this.ruleForm.laoshiName = obj[o];
                          this.ro.laoshiName = true;
                          continue;
                      }
                      if(o=='laoshiPhone'){
                          this.ruleForm.laoshiPhone = obj[o];
                          this.ro.laoshiPhone = true;
                          continue;
                      }
                      if(o=='laoshiIdNumber'){
                          this.ruleForm.laoshiIdNumber = obj[o];
                          this.ro.laoshiIdNumber = true;
                          continue;
                      }
                      if(o=='laoshiPhoto'){
                          this.ruleForm.laoshiPhoto = obj[o];
                          this.ro.laoshiPhoto = true;
                          continue;
                      }
                      if(o=='sexTypes'){
                      ...
                      if(o=='laoshiEmail'){
                          this.ruleForm.laoshiEmail = obj[o];
                          this.ro.laoshiEmail = true;
                          continue;
                      }
                    }
                }
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`laoshi/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.laoshiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
