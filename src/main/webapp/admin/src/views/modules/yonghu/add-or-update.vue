               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="学员姓名" prop="yonghuName">
                       <el-input v-model="ruleForm.yonghuName"
                                 placeholder="学员姓名" clearable  :readonly="ro.yonghuName"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="学员手机号" prop="yonghuPhone">
                       <el-input v-model="ruleForm.yonghuPhone"
                                 placeholder="学员手机号" clearable  :readonly="ro.yonghuPhone"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="学员身份证号" prop="yonghuIdNumber">
                       <el-input v-model="ruleForm.yonghuIdNumber"
                                 placeholder="学员身份证号" clearable  :readonly="ro.yonghuIdNumber"></el-input>
                   </el-form-item>
                   <div v-else>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   yonghuIdNumber: [
                              { required: true, message: '学员身份证号不能为空', trigger: 'blur' },
