...
<template>
    <div class="main-content">
        <el-dialog title="帖子回复详情" :visible.sync="forumReplyDialogVisible">
            ...
            <div class="demo-input-suffix">
                <span v-if="sessionTable != 'xiaozhang'" style="width: 20%">回帖内容：</span>
                <el-input v-if="sessionTable != 'xiaozhang'" v-model="forumReplyContent" placeholder="回帖内容" style="width:80%" type="textarea"></el-input>
            </div>

            <div slot="footer" class="dialog-footer">
                <el-button @click="forumReplyDialogVisible = false">取 消</el-button>
                <el-button v-if="sessionTable != 'xiaozhang'" type="primary" @click="forumReply">回 帖</el-button>
            </div>
        </el-dialog>
        <!-- 条件查询 -->
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/jiaoxueziyuan/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.laoshiId = el.laoshiId;//---
                            forum.laoshiName = el.laoshiName;
                            forum.laoshiPhone = el.laoshiPhone;
                            forum.laoshiIdNumber = el.laoshiIdNumber;
                            forum.laoshiPhoto = el.laoshiPhoto;
                            forum.laoshiEmail = el.laoshiEmail;
                            forum.createTime = el.createTime;
