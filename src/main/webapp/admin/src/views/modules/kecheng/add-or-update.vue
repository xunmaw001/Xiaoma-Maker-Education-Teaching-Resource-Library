    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='laoshi'">
                    <el-form-item class="select" v-if="type!='info'"  label="老师" prop="laoshiId">
                        <el-select v-model="ruleForm.laoshiId" filterable placeholder="请选择老师" @change="laoshiChange">
                            <el-option
            ...
            <input id="laoshiId" name="laoshiId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="老师名字" prop="tempLaoshiName">
                       <el-input v-model="ruleForm.tempLaoshiName"
                                 placeholder="老师名字" clearable  :readonly="ro.tempLaoshiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="老师名字" prop="tempLaoshiName">
                           <el-input v-model="ruleForm.tempLaoshiName"
                                     placeholder="老师名字" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="课程名字" prop="kechengName">
                       <el-input v-model="ruleForm.kechengName"
                                 placeholder="课程名字" clearable  :readonly="ro.kechengName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="课程名字" prop="kechengName">
                           <el-input v-model="ruleForm.kechengName"
                                     placeholder="课程名字" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="课程地点" prop="kechengAddress">
                       <el-input v-model="ruleForm.kechengAddress"
                                 placeholder="课程地点" clearable  :readonly="ro.kechengAddress"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="课程地点" prop="kechengAddress">
                           <el-input v-model="ruleForm.kechengAddress"
                                     placeholder="课程地点" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="课程形式" prop="kechengTypes">
                        <el-select v-model="ruleForm.kechengTypes" placeholder="请选择课程形式">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="课程形式" prop="kechengValue">
                        <el-input v-model="ruleForm.kechengValue"
                            placeholder="课程形式" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   kechengTypes: [
                              { required: true, message: '课程形式不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='tempLaoshiName'){
                          this.ruleForm.tempLaoshiName = obj[o];
                          this.ro.tempLaoshiName = true;
                          continue;
                      }
                      if(o=='kechengName'){
                          this.ruleForm.kechengName = obj[o];
                          this.ro.kechengName = true;
                          continue;
                      }
                      if(o=='kechengAddress'){
                          this.ruleForm.kechengAddress = obj[o];
                          this.ro.kechengAddress = true;
                          continue;
                      }
                      if(o=='kechengTypes'){
            ...
            laoshiChange(id){
                this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        this.ruleForm.tempLaoshiName= data.data.laoshiName;
                    }
                });
            },
            // 多级联动参数
